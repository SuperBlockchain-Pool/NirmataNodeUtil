...
namespace nodetool
{
  ...
  const static boost::uuids::uuid P2P_NETWORK_ID = { { 0x10, 0x11, 0x01, 0x11, 0x11, 0x01, 0x11, 0x01, 0x10, 0x01, P2P_NETWORK_ID_TESTNET_FLAG, 0x21, 0x11, 0x01, 0x11, P2P_NETWORK_ID_VER} };
  ...
  {
#ifndef TESTNET
    ADD_HARDCODED_SEED_NODE("103.35.188.185", P2P_DEFAULT_PORT);
    ADD_HARDCODED_SEED_NODE("194.156.99.233", P2P_DEFAULT_PORT);
    ADD_HARDCODED_SEED_NODE("194.33.87.233", P2P_DEFAULT_PORT);
    ADD_HARDCODED_SEED_NODE("93.81.247.211", P2P_DEFAULT_PORT);
#else
    ADD_HARDCODED_SEED_NODE("103.35.188.185", P2P_DEFAULT_PORT);
    ADD_HARDCODED_SEED_NODE("194.156.99.233", P2P_DEFAULT_PORT);
    ADD_HARDCODED_SEED_NODE("194.33.87.233", P2P_DEFAULT_PORT);
