...
namespace nodetool
{
  ...
  const static boost::uuids::uuid P2P_NETWORK_ID = { { 0x01, 0x11, 0x11, 0x01, 0x11, 0x11, 0x01, 0x10, 0x01, 0x10, P2P_NETWORK_ID_TESTNET_FLAG, 0x01, 0x11, 0x21, 0x11, P2P_NETWORK_ID_VER} };
